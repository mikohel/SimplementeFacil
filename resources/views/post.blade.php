...
@foreach ($posts as $post ) 
  <div class="carousel-item tajeta-carrusel tca   ">
                ...
                <div class="row g-0 border rounded overflow-hidden flex-md-row   position-relative  cyan lighten-5  z-depth-3 ">
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <h2 class="blog-post-title">{{$imgps->title}}</h2>
        ...
        <p style="text-align: justify;" >{{$imgps->body}}</p>
        <h3>Example lists</h3>
